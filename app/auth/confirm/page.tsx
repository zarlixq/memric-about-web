...
const supabase = createClient(
  process.env.NEXT_PUBLIC_SUPABASE_URL!,       // .env’de tanımlı olmalı
  process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY!   // .env’de tanımlı olmalı
);
...
export default function ConfirmEmailPage() {
  ...
  // Supabase linkinden gelen paramlar:
  ...
  useEffect(() => {
    // token yoksa ana sayfaya gönder
    if (!token_hash) {
      router.replace("/");
      return;
    }
