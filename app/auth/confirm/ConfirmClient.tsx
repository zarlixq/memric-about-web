...
// Supabase istemcisini tek bir yerden içe aktardığını varsayıyoruz
...
  useEffect(() => {
    // BURAYA BİR KONTROL EKLE!
    // Eğer `useSearchParams` henüz yüklenmediyse bekle.
    if (sp.size === 0) return;
...
      cancelled = true;
    };
  }, [tokenHash, type, router, sp.size]); // Bağımlılık dizisine sp.size eklemeyi unutma!
